...
img: assets/img/logos/dyneo4slums.png
importance: 1
category: research
related_publications: false
---

<a href="https://dyneo4slums.ulb.be/" target="_blank" rel="noopener noreferrer" class="btn mt-3 d-block" style="background-color: var(--global-theme-color); color: white; width: 50%; font-size: 1rem; padding: 0.6rem 1rem;">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dyneo4slumsteam.jpg" title="DynEOSLUMS Team" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="publications">
  {% bibliography --query @*[projects~=dyneo4slums] %}
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dyneo4slumsfunding.png" title="DynEO4SLUMS funder and partners" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>