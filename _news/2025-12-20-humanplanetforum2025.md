...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/humanplanet2.png" title="human planet forum" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/humanplanet3.png" title="human planet forum" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
