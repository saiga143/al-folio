...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/coringa1.jpg" title="Coringa stakeholder meeting" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/coringa2.jpg" title="Coringa stakeholder meeting" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/coringa3.jpg" title="Coringa stakeholder meeting" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/coringa4.jpg" title="Coringa stakeholder meeting" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>